...
.method public a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/f/b$b;I)Landroid/graphics/Typeface;
    ...
    :try_start_1
    invoke-virtual {p0, p1, p3}, Landroid/support/v4/c/g;->a(Landroid/content/Context;Ljava/io/InputStream;)Landroid/graphics/Typeface;
    ...
    invoke-static {p3}, Landroid/support/v4/c/h;->a(Ljava/io/Closeable;)V
...
.method public a(Landroid/content/Context;Landroid/support/v4/b/a/a$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    :cond_0
    invoke-virtual {p2}, Landroid/support/v4/b/a/a$c;->d()I

    move-result v0

    invoke-virtual {p2}, Landroid/support/v4/b/a/a$c;->a()Ljava/lang/String;
...
.method protected a(Landroid/content/Context;Ljava/io/InputStream;)Landroid/graphics/Typeface;
    ...
    :cond_0
    :try_start_0
    invoke-static {p1, p2}, Landroid/support/v4/c/h;->a(Ljava/io/File;Ljava/io/InputStream;)Z
