...
.method public a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/f/b$b;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/g/k;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p1, p2, v4}, Landroid/support/v4/c/h;->a(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;

    move-result-object v5

    invoke-virtual {v0, v4, v5}, Landroid/support/v4/g/k;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_0
    invoke-virtual {v3}, Landroid/support/v4/f/b$b;->b()I

    move-result v4

    invoke-virtual {v3}, Landroid/support/v4/f/b$b;->c()I

    move-result v6

    invoke-virtual {v3}, Landroid/support/v4/f/b$b;->d()Z

    move-result v3

    invoke-static {p4, v5, v4, v6, v3}, Landroid/support/v4/c/e;->a(Ljava/lang/Object;Ljava/nio/ByteBuffer;IIZ)Z
...
.method public a(Landroid/content/Context;Landroid/support/v4/b/a/a$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v3}, Landroid/support/v4/b/a/a$c;->d()I
    ...
    invoke-virtual {v3}, Landroid/support/v4/b/a/a$c;->b()I

    move-result v5

    invoke-virtual {v3}, Landroid/support/v4/b/a/a$c;->c()Z

    move-result v3

    invoke-static {p4, v4, v0, v5, v3}, Landroid/support/v4/c/e;->a(Ljava/lang/Object;Ljava/nio/ByteBuffer;IIZ)Z
