...
.method private d(I)Landroid/view/ViewParent;
    ...
    :pswitch_0
    iget-object p1, p0, Landroid/support/v4/h/j;->b:Landroid/view/ViewParent;

    return-object p1

    :pswitch_1
    iget-object p1, p0, Landroid/support/v4/h/j;->a:Landroid/view/ViewParent;
...
.method public a(FF)Z
    ...
    invoke-direct {p0, v1}, Landroid/support/v4/h/j;->d(I)Landroid/view/ViewParent;
    ...
    invoke-static {v0, v1, p1, p2}, Landroid/support/v4/h/q;->a(Landroid/view/ViewParent;Landroid/view/View;FF)Z
...
.method public a(FFZ)Z
    ...
    invoke-static {v0, v1, p1, p2, p3}, Landroid/support/v4/h/q;->a(Landroid/view/ViewParent;Landroid/view/View;FFZ)Z
...
.method public a(II)Z
    ...
    iget-object v2, p0, Landroid/support/v4/h/j;->c:Landroid/view/View;
    ...
    invoke-static {v0, v2, v3, p1, p2}, Landroid/support/v4/h/q;->a(Landroid/view/ViewParent;Landroid/view/View;Landroid/view/View;II)Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-direct {p0, p2, v0}, Landroid/support/v4/h/j;->a(ILandroid/view/ViewParent;)V

    iget-object v3, p0, Landroid/support/v4/h/j;->c:Landroid/view/View;

    invoke-static {v0, v2, v3, p1, p2}, Landroid/support/v4/h/q;->b(Landroid/view/ViewParent;Landroid/view/View;Landroid/view/View;II)V
...
.method public a(IIII[II)Z
    ...
    invoke-direct {v0, v2}, Landroid/support/v4/h/j;->d(I)Landroid/view/ViewParent;
    ...
    iget-object v5, v0, Landroid/support/v4/h/j;->c:Landroid/view/View;
    ...
    invoke-static/range {v4 .. v10}, Landroid/support/v4/h/q;->a(Landroid/view/ViewParent;Landroid/view/View;IIIII)V

    if-eqz v1, :cond_4

    iget-object v2, v0, Landroid/support/v4/h/j;->c:Landroid/view/View;
...
.method public a(II[I[II)Z
    ...
    iget-object p3, p0, Landroid/support/v4/h/j;->e:[I
    ...
    iput-object p3, p0, Landroid/support/v4/h/j;->e:[I
    ...
    invoke-static/range {v2 .. v7}, Landroid/support/v4/h/q;->a(Landroid/view/ViewParent;Landroid/view/View;II[II)V

    if-eqz p4, :cond_6

    iget-object p1, p0, Landroid/support/v4/h/j;->c:Landroid/view/View;
