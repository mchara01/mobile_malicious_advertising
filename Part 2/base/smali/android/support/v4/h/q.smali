...
.method public static a(Landroid/view/ViewParent;Landroid/view/View;I)V
    ...
    sget-object p2, Landroid/support/v4/h/q;->a:Landroid/support/v4/h/q$c;

    invoke-virtual {p2, p0, p1}, Landroid/support/v4/h/q$c;->a(Landroid/view/ViewParent;Landroid/view/View;)V
...
.method public static a(Landroid/view/ViewParent;Landroid/view/View;IIIII)V
    ...
    invoke-interface/range {v1 .. v7}, Landroid/support/v4/h/l;->a(Landroid/view/View;IIIII)V
    ...
    sget-object v2, Landroid/support/v4/h/q;->a:Landroid/support/v4/h/q$c;
    ...
    invoke-virtual/range {v2 .. v8}, Landroid/support/v4/h/q$c;->a(Landroid/view/ViewParent;Landroid/view/View;IIII)V
...
.method public static a(Landroid/view/ViewParent;Landroid/view/View;II[II)V
    ...
    invoke-interface/range {v1 .. v6}, Landroid/support/v4/h/l;->a(Landroid/view/View;II[II)V
    ...
    invoke-virtual/range {v2 .. v7}, Landroid/support/v4/h/q$c;->a(Landroid/view/ViewParent;Landroid/view/View;II[I)V
...
.method public static a(Landroid/view/ViewParent;Landroid/view/View;Landroid/view/View;II)Z
    ...
    sget-object p4, Landroid/support/v4/h/q;->a:Landroid/support/v4/h/q$c;

    invoke-virtual {p4, p0, p1, p2, p3}, Landroid/support/v4/h/q$c;->a(Landroid/view/ViewParent;Landroid/view/View;Landroid/view/View;I)Z
...
.method public static b(Landroid/view/ViewParent;Landroid/view/View;Landroid/view/View;II)V
    ...
    invoke-virtual {p4, p0, p1, p2, p3}, Landroid/support/v4/h/q$c;->b(Landroid/view/ViewParent;Landroid/view/View;Landroid/view/View;I)V
