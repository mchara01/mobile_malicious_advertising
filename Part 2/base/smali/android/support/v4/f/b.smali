...
.method public static a(Landroid/content/Context;Landroid/support/v4/f/a;Landroid/widget/TextView;III)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/g/g;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v1, p0, p1, p5, v0}, Landroid/support/v4/f/b$1;-><init>(Landroid/content/Context;Landroid/support/v4/f/a;ILjava/lang/String;)V
    ...
    invoke-virtual {p1, v1, p4}, Landroid/support/v4/f/c;->a(Ljava/util/concurrent/Callable;I)Ljava/lang/Object;
    ...
    new-instance p3, Landroid/support/v4/f/b$2;

    invoke-direct {p3, p1, p2, p5}, Landroid/support/v4/f/b$2;-><init>(Ljava/lang/ref/WeakReference;Landroid/widget/TextView;I)V
    ...
    :try_start_1
    sget-object p2, Landroid/support/v4/f/b;->d:Landroid/support/v4/g/k;

    invoke-virtual {p2, v0}, Landroid/support/v4/g/k;->containsKey(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/g/k;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object p3, Landroid/support/v4/f/b;->d:Landroid/support/v4/g/k;

    invoke-virtual {p3, v0, p2}, Landroid/support/v4/g/k;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static a(Landroid/support/v4/f/a;Landroid/content/res/Resources;)Ljava/util/List;
    ...
    invoke-static {p1, p0}, Landroid/support/v4/b/a/a;->a(Landroid/content/res/Resources;I)Ljava/util/List;
...
.method private static b(Landroid/content/Context;Landroid/support/v4/f/a;I)Landroid/graphics/Typeface;
    ...
    invoke-static {p0, v0, p1, p2}, Landroid/support/v4/c/c;->a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/f/b$b;I)Landroid/graphics/Typeface;
