...
.method static constructor <clinit>()V
    ...
    sput-object v2, Landroid/support/v7/widget/aj;->a:Ljava/lang/reflect/Method;
    :try_end_0
    ...
    sput-object v2, Landroid/support/v7/widget/aj;->b:Ljava/lang/reflect/Method;
    :try_end_1
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v1, v0}, Landroid/support/v7/widget/aj;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/aj;->q:Z

    const/4 v1, 0x0

    iput v1, p0, Landroid/support/v7/widget/aj;->t:I

    iput-boolean v1, p0, Landroid/support/v7/widget/aj;->u:Z

    iput-boolean v1, p0, Landroid/support/v7/widget/aj;->v:Z

    const v2, 0x7fffffff

    iput v2, p0, Landroid/support/v7/widget/aj;->d:I

    iput v1, p0, Landroid/support/v7/widget/aj;->x:I

    new-instance v2, Landroid/support/v7/widget/aj$e;

    invoke-direct {v2, p0}, Landroid/support/v7/widget/aj$e;-><init>(Landroid/support/v7/widget/aj;)V

    iput-object v2, p0, Landroid/support/v7/widget/aj;->e:Landroid/support/v7/widget/aj$e;

    new-instance v2, Landroid/support/v7/widget/aj$d;

    invoke-direct {v2, p0}, Landroid/support/v7/widget/aj$d;-><init>(Landroid/support/v7/widget/aj;)V

    iput-object v2, p0, Landroid/support/v7/widget/aj;->D:Landroid/support/v7/widget/aj$d;

    new-instance v2, Landroid/support/v7/widget/aj$c;

    invoke-direct {v2, p0}, Landroid/support/v7/widget/aj$c;-><init>(Landroid/support/v7/widget/aj;)V

    iput-object v2, p0, Landroid/support/v7/widget/aj;->E:Landroid/support/v7/widget/aj$c;

    new-instance v2, Landroid/support/v7/widget/aj$a;

    invoke-direct {v2, p0}, Landroid/support/v7/widget/aj$a;-><init>(Landroid/support/v7/widget/aj;)V

    iput-object v2, p0, Landroid/support/v7/widget/aj;->F:Landroid/support/v7/widget/aj$a;

    new-instance v2, Landroid/graphics/Rect;

    invoke-direct {v2}, Landroid/graphics/Rect;-><init>()V

    iput-object v2, p0, Landroid/support/v7/widget/aj;->H:Landroid/graphics/Rect;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/aj;->f:Landroid/os/Handler;
    ...
    iput v3, p0, Landroid/support/v7/widget/aj;->m:I
    ...
    iput-object v1, p0, Landroid/support/v7/widget/aj;->g:Landroid/widget/PopupWindow;

    iget-object p1, p0, Landroid/support/v7/widget/aj;->g:Landroid/widget/PopupWindow;
...
.method private a(Landroid/view/View;IZ)I
    ...
    :cond_0
    iget-object p3, p0, Landroid/support/v7/widget/aj;->g:Landroid/widget/PopupWindow;
...
.method private f()I
    ...
    new-instance v5, Landroid/support/v7/widget/aj$1;

    invoke-direct {v5, p0}, Landroid/support/v7/widget/aj$1;-><init>(Landroid/support/v7/widget/aj;)V

    iput-object v5, p0, Landroid/support/v7/widget/aj;->G:Ljava/lang/Runnable;

    iget-boolean v5, p0, Landroid/support/v7/widget/aj;->J:Z

    xor-int/2addr v5, v3

    invoke-virtual {p0, v0, v5}, Landroid/support/v7/widget/aj;->a(Landroid/content/Context;Z)Landroid/support/v7/widget/af;

    move-result-object v5

    iput-object v5, p0, Landroid/support/v7/widget/aj;->c:Landroid/support/v7/widget/af;

    iget-object v5, p0, Landroid/support/v7/widget/aj;->A:Landroid/graphics/drawable/Drawable;

    if-eqz v5, :cond_0

    iget-object v5, p0, Landroid/support/v7/widget/aj;->c:Landroid/support/v7/widget/af;

    iget-object v6, p0, Landroid/support/v7/widget/aj;->A:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v5, v6}, Landroid/support/v7/widget/af;->setSelector(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v5, v6}, Landroid/support/v7/widget/af;->setAdapter(Landroid/widget/ListAdapter;)V

    iget-object v5, p0, Landroid/support/v7/widget/aj;->c:Landroid/support/v7/widget/af;

    iget-object v6, p0, Landroid/support/v7/widget/aj;->B:Landroid/widget/AdapterView$OnItemClickListener;

    invoke-virtual {v5, v6}, Landroid/support/v7/widget/af;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v5, p0, Landroid/support/v7/widget/aj;->c:Landroid/support/v7/widget/af;

    invoke-virtual {v5, v3}, Landroid/support/v7/widget/af;->setFocusable(Z)V

    iget-object v5, p0, Landroid/support/v7/widget/aj;->c:Landroid/support/v7/widget/af;

    invoke-virtual {v5, v3}, Landroid/support/v7/widget/af;->setFocusableInTouchMode(Z)V
    ...
    invoke-virtual {v5, v6}, Landroid/support/v7/widget/af;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V

    iget-object v5, p0, Landroid/support/v7/widget/aj;->c:Landroid/support/v7/widget/af;

    iget-object v6, p0, Landroid/support/v7/widget/aj;->E:Landroid/support/v7/widget/aj$c;

    invoke-virtual {v5, v6}, Landroid/support/v7/widget/af;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V

    iget-object v5, p0, Landroid/support/v7/widget/aj;->C:Landroid/widget/AdapterView$OnItemSelectedListener;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/aj;->w:Landroid/view/View;
    ...
    :goto_3
    iget-object v5, p0, Landroid/support/v7/widget/aj;->g:Landroid/widget/PopupWindow;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/aj;->H:Landroid/graphics/Rect;
    ...
    iget-boolean v6, p0, Landroid/support/v7/widget/aj;->p:Z
    ...
    iput v6, p0, Landroid/support/v7/widget/aj;->n:I
    ...
    iget v6, p0, Landroid/support/v7/widget/aj;->n:I

    invoke-direct {p0, v4, v6, v3}, Landroid/support/v7/widget/aj;->a(Landroid/view/View;IZ)I

    move-result v3

    iget-boolean v4, p0, Landroid/support/v7/widget/aj;->u:Z
    ...
    :pswitch_2
    iget-object v1, p0, Landroid/support/v7/widget/aj;->i:Landroid/content/Context;
    ...
    :pswitch_3
    iget-object v2, p0, Landroid/support/v7/widget/aj;->i:Landroid/content/Context;
    ...
    :goto_8
    iget-object v6, p0, Landroid/support/v7/widget/aj;->c:Landroid/support/v7/widget/af;
    ...
    invoke-virtual/range {v6 .. v11}, Landroid/support/v7/widget/af;->a(IIIII)I
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/af;->getPaddingTop()I

    move-result v2

    iget-object v3, p0, Landroid/support/v7/widget/aj;->c:Landroid/support/v7/widget/af;

    invoke-virtual {v3}, Landroid/support/v7/widget/af;->getPaddingBottom()I
...
.method public a()V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/aj;->g:Landroid/widget/PopupWindow;
    ...
    invoke-static {v2}, Landroid/support/v4/h/p;->m(Landroid/view/View;)Z
    ...
    :goto_0
    iget v7, p0, Landroid/support/v7/widget/aj;->k:I
    ...
    iget-boolean v4, p0, Landroid/support/v7/widget/aj;->v:Z
    ...
    iget-object v7, p0, Landroid/support/v7/widget/aj;->g:Landroid/widget/PopupWindow;

    invoke-virtual {p0}, Landroid/support/v7/widget/aj;->i()Landroid/view/View;

    move-result-object v8

    iget v9, p0, Landroid/support/v7/widget/aj;->m:I

    iget v10, p0, Landroid/support/v7/widget/aj;->n:I
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/aj;->v:Z

    if-nez v1, :cond_11

    iget-boolean v1, p0, Landroid/support/v7/widget/aj;->u:Z
    ...
    iget-object v3, p0, Landroid/support/v7/widget/aj;->I:Landroid/graphics/Rect;
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/af;->setSelection(I)V
...
.method public a(Landroid/widget/ListAdapter;)V
    ...
    :cond_2
    iget-object p1, p0, Landroid/support/v7/widget/aj;->c:Landroid/support/v7/widget/af;
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/af;->setAdapter(Landroid/widget/ListAdapter;)V
...
.method public d(I)V
    ...
    iput-boolean p1, p0, Landroid/support/v7/widget/aj;->p:Z
