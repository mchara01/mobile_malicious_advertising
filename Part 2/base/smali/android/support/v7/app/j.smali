...
.field p:Landroid/support/v4/h/r;

.field q:Z

.field r:I

.field private t:Landroid/support/v7/widget/ac;
...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/c;)V
    ...
    iput-object p1, p0, Landroid/support/v7/app/j;->p:Landroid/support/v4/h/r;
    ...
    iput-object p1, p0, Landroid/support/v7/app/j;->G:Ljava/lang/Runnable;
...
.method private a(Landroid/support/v7/view/menu/h;Z)V
    ...
    iget-object p1, p0, Landroid/support/v7/app/j;->t:Landroid/support/v7/widget/ac;
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/ac;->g()Z
    ...
    iget-object v2, p0, Landroid/support/v7/app/j;->t:Landroid/support/v7/widget/ac;

    invoke-interface {v2}, Landroid/support/v7/widget/ac;->f()Z
    ...
    :cond_1
    iget-object p2, p0, Landroid/support/v7/app/j;->t:Landroid/support/v7/widget/ac;

    invoke-interface {p2}, Landroid/support/v7/widget/ac;->i()Z
    ...
    iget-boolean p2, p0, Landroid/support/v7/app/j;->q:Z

    if-eqz p2, :cond_3

    iget p2, p0, Landroid/support/v7/app/j;->r:I
    ...
    iget-object p2, p0, Landroid/support/v7/app/j;->G:Ljava/lang/Runnable;
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/ac;->h()Z
...
.method private a(Landroid/support/v7/app/j$d;ILandroid/view/KeyEvent;I)Z
    ...
    iget-object p3, p0, Landroid/support/v7/app/j;->t:Landroid/support/v7/widget/ac;
...
.method private b(Landroid/support/v7/app/j$d;)Z
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/app/j;->t:Landroid/support/v7/widget/ac;
...
.method private b(Landroid/support/v7/app/j$d;Landroid/view/KeyEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v7/app/j;->t:Landroid/support/v7/widget/ac;
    ...
    iget-object v7, p0, Landroid/support/v7/app/j;->u:Landroid/support/v7/app/j$a;

    invoke-interface {v4, v6, v7}, Landroid/support/v7/widget/ac;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
    ...
    iget-object p2, p0, Landroid/support/v7/app/j;->u:Landroid/support/v7/app/j$a;

    invoke-interface {p1, v5, p2}, Landroid/support/v7/widget/ac;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
    ...
    iget-object v0, p0, Landroid/support/v7/app/j;->u:Landroid/support/v7/app/j$a;

    invoke-interface {p2, v5, v0}, Landroid/support/v7/widget/ac;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
...
.method private d(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/app/j;->G:Ljava/lang/Runnable;

    invoke-static {p1, v0}, Landroid/support/v4/h/p;->a(Landroid/view/View;Ljava/lang/Runnable;)V

    iput-boolean v1, p0, Landroid/support/v7/app/j;->q:Z
...
.method private e(ILandroid/view/KeyEvent;)Z
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/ac;->i()Z
...
.method private t()Landroid/view/ViewGroup;
    ...
    iput-object v1, p0, Landroid/support/v7/app/j;->t:Landroid/support/v7/widget/ac;
    ...
    invoke-interface {v1, v3}, Landroid/support/v7/widget/ac;->setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v1, v4}, Landroid/support/v7/widget/ac;->a(I)V
    ...
    invoke-interface {v1, v3}, Landroid/support/v7/widget/ac;->a(I)V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/h/p;->a(Landroid/view/View;Landroid/support/v4/h/n;)V
    ...
    iput-object v1, p0, Landroid/support/v7/app/j;->y:Landroid/widget/TextView;
...
.method protected a(IZ)Landroid/support/v7/app/j$d;
    ...
    iget-object p2, p0, Landroid/support/v7/app/j;->D:[Landroid/support/v7/app/j$d;
    ...
    :cond_1
    iput-object v0, p0, Landroid/support/v7/app/j;->D:[Landroid/support/v7/app/j$d;
...
.method a(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    ...
    iget-object v5, p0, Landroid/support/v7/app/j;->m:Landroid/support/v7/widget/ActionBarContextView;

    iget-object v6, p0, Landroid/support/v7/app/j;->n:Landroid/widget/PopupWindow;
    ...
    invoke-static {p1}, Landroid/support/v4/h/p;->d(Landroid/view/View;)Landroid/support/v4/h/r;

    move-result-object p1

    invoke-virtual {p1, v0}, Landroid/support/v4/h/r;->a(F)Landroid/support/v4/h/r;

    move-result-object p1

    iput-object p1, p0, Landroid/support/v7/app/j;->p:Landroid/support/v4/h/r;

    iget-object p1, p0, Landroid/support/v7/app/j;->p:Landroid/support/v4/h/r;
    ...
    invoke-virtual {p1, v0}, Landroid/support/v4/h/r;->a(Landroid/support/v4/h/s;)Landroid/support/v4/h/r;
    ...
    :cond_9
    :goto_4
    iget-object p1, p0, Landroid/support/v7/app/j;->n:Landroid/widget/PopupWindow;
    ...
    iget-object v0, p0, Landroid/support/v7/app/j;->o:Ljava/lang/Runnable;
    ...
    :cond_b
    :goto_5
    iget-object p1, p0, Landroid/support/v7/app/j;->l:Landroid/support/v7/view/b;

    if-eqz p1, :cond_c

    iget-object p1, p0, Landroid/support/v7/app/j;->e:Landroid/support/v7/app/c;
...
.method public a(Landroid/os/Bundle;)V
    ...
    invoke-static {p1}, Landroid/support/v4/a/w;->a(Landroid/app/Activity;)Ljava/lang/String;
...
.method a(Landroid/support/v7/app/j$d;Z)V
    ...
    iget-object v0, p0, Landroid/support/v7/app/j;->t:Landroid/support/v7/widget/ac;
    ...
    iput-object v1, p0, Landroid/support/v7/app/j;->E:Landroid/support/v7/app/j$d;
...
.method a(ILandroid/view/KeyEvent;)Z
    ...
    :cond_0
    iget-object p1, p0, Landroid/support/v7/app/j;->E:Landroid/support/v7/app/j$d;
...
.method public b(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    ...
    iput-object p1, p0, Landroid/support/v7/app/j;->l:Landroid/support/v7/view/b;
...
.method public b(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    iget-object v2, p0, Landroid/support/v7/app/j;->K:Landroid/support/v7/app/l;

    sget-boolean v8, Landroid/support/v7/app/j;->s:Z
...
.method b(Landroid/support/v7/view/menu/h;)V
    ...
    iput-boolean p1, p0, Landroid/support/v7/app/j;->C:Z
...
.method b(ILandroid/view/KeyEvent;)Z
    ...
    :cond_1
    iget-boolean p1, p0, Landroid/support/v7/app/j;->F:Z

    iput-boolean v2, p0, Landroid/support/v7/app/j;->F:Z
...
.method public c(I)Z
    ...
    iput-boolean v2, p0, Landroid/support/v7/app/j;->k:Z
...
.method g(I)I
    ...
    iget-object v2, p0, Landroid/support/v7/app/j;->m:Landroid/support/v7/widget/ActionBarContextView;
    ...
    iget-object v2, p0, Landroid/support/v7/app/j;->I:Landroid/graphics/Rect;
    ...
    iput-object v2, p0, Landroid/support/v7/app/j;->I:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Landroid/support/v7/app/j;->z:Landroid/view/View;
    ...
    iput-object v2, p0, Landroid/support/v7/app/j;->z:Landroid/view/View;
    ...
    iget-object v2, p0, Landroid/support/v7/app/j;->x:Landroid/view/ViewGroup;
    ...
    :cond_a
    :goto_5
    iget-object v0, p0, Landroid/support/v7/app/j;->z:Landroid/view/View;
...
.method p()V
    ...
    iget-object v0, p0, Landroid/support/v7/app/j;->p:Landroid/support/v4/h/r;
