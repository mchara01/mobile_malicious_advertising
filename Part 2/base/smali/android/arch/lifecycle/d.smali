...
.method public constructor <init>(Landroid/arch/lifecycle/c;)V
    ...
    sget-object p1, Landroid/arch/lifecycle/b$b;->b:Landroid/arch/lifecycle/b$b;
...
.method private a()Z
    ...
    iget-object v2, p0, Landroid/arch/lifecycle/d;->a:Landroid/arch/a/a/a;
    ...
    iget-object v2, v2, Landroid/arch/lifecycle/d$a;->a:Landroid/arch/lifecycle/b$b;

    if-ne v0, v2, :cond_1

    iget-object v0, p0, Landroid/arch/lifecycle/d;->b:Landroid/arch/lifecycle/b$b;
...
.method static b(Landroid/arch/lifecycle/b$a;)Landroid/arch/lifecycle/b$b;
    ...
    :pswitch_0
    sget-object p0, Landroid/arch/lifecycle/b$b;->a:Landroid/arch/lifecycle/b$b;

    return-object p0

    :pswitch_1
    sget-object p0, Landroid/arch/lifecycle/b$b;->e:Landroid/arch/lifecycle/b$b;

    return-object p0

    :pswitch_2
    sget-object p0, Landroid/arch/lifecycle/b$b;->d:Landroid/arch/lifecycle/b$b;

    return-object p0

    :pswitch_3
    sget-object p0, Landroid/arch/lifecycle/b$b;->c:Landroid/arch/lifecycle/b$b;
...
.method private c()V
    ...
    :goto_0
    iget-object v3, v2, Landroid/arch/lifecycle/d$a;->a:Landroid/arch/lifecycle/b$b;
    ...
    iget-object v4, v2, Landroid/arch/lifecycle/d$a;->a:Landroid/arch/lifecycle/b$b;

    invoke-static {v4}, Landroid/arch/lifecycle/d;->d(Landroid/arch/lifecycle/b$b;)Landroid/arch/lifecycle/b$a;

    move-result-object v4

    invoke-virtual {v2, v3, v4}, Landroid/arch/lifecycle/d$a;->a(Landroid/arch/lifecycle/c;Landroid/arch/lifecycle/b$a;)V
...
.method private d()V
    ...
    invoke-virtual {v2, v4, v3}, Landroid/arch/lifecycle/d$a;->a(Landroid/arch/lifecycle/c;Landroid/arch/lifecycle/b$a;)V
...
.method private e()V
    ...
    iget-object v1, p0, Landroid/arch/lifecycle/d;->a:Landroid/arch/a/a/a;
    ...
    iget-object v1, v1, Landroid/arch/lifecycle/d$a;->a:Landroid/arch/lifecycle/b$b;
