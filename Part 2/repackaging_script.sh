...
# De-compile base.apk
echo "${RED}Decompiling $APKFILE...${NC}"
...
echo "${RED}Modifying AndroidManifest.xml...${NC}"
...
echo "${RED}Recompiling modified application...${NC}"
...
echo "${RED}Signing repackaged application...${NC}"
